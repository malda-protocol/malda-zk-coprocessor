...
use malda_utils::{types::SequencerCommitment, validators::validate_get_proof_data_call};
...
use malda_utils::constants::{
  BASE_SEPOLIA_CHAIN_ID, ETHEREUM_SEPOLIA_CHAIN_ID, LINEA_SEPOLIA_CHAIN_ID,
...
fn main() {
  ...
  for _i in 0..length {
    ...
    #[cfg(feature = "testnet")]
    if chain_id != LINEA_SEPOLIA_CHAIN_ID
