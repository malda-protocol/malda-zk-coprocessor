...
pub const REORG_PROTECTION_DEPTH_OPTIMISM_SEPOLIA: u64 = 5;
pub const REORG_PROTECTION_DEPTH_BASE_SEPOLIA: u64 = 0;
pub const REORG_PROTECTION_DEPTH_LINEA_SEPOLIA: u64 = 2;
pub const REORG_PROTECTION_DEPTH_ETHEREUM_SEPOLIA: u64 = 4;
pub const REORG_PROTECTION_DEPTH_SCROLL_SEPOLIA: u64 = 0;

pub const USDC_MARKET_SEPOLIA: Address = address!("c15EF00790b987ce4B82eB9e25e1233a89589510");
