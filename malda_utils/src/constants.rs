...
pub const REORG_PROTECTION_DEPTH_OPTIMISM_SEPOLIA: u64 = 4;
pub const REORG_PROTECTION_DEPTH_BASE_SEPOLIA: u64 = 0;
pub const REORG_PROTECTION_DEPTH_LINEA_SEPOLIA: u64 = 3;
pub const REORG_PROTECTION_DEPTH_ETHEREUM_SEPOLIA: u64 = 2;
pub const REORG_PROTECTION_DEPTH_SCROLL_SEPOLIA: u64 = 0;

pub const USDC_MARKET_SEPOLIA: Address = address!("dBD51760d3E8EF3f5Ef67AbA5d2df341bAAeEE38");
pub const WETH_MARKET_SEPOLIA: Address = address!("b7c80266B11f6bfC431FF2c774E26E7262C7aA4D");
